      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> chennai, tamilnadu, India</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:rawatcoder@gmail.com" className="d-block" >plango@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:9876543210" className="d-block" >9789847384</a>
          </div>
